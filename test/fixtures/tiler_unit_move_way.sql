...
INSERT INTO nodes VALUES (4, 1, 't', 1, NOW(), 3, '', ST_SetSRID(ST_GeomFromText('POINT(1 1)'), 4326));
INSERT INTO nodes VALUES (5, 1, 't', 1, NOW(), 3, '', ST_SetSRID(ST_GeomFromText('POINT(2 2)'), 4326));
INSERT INTO nodes VALUES (6, 1, 't', 1, NOW(), 3, '', ST_SetSRID(ST_GeomFromText('POINT(3 3)'), 4326));
INSERT INTO ways VALUES (4, 1, 't', 1, NOW(), 3, '', ARRAY[4, 5, 6]);
INSERT INTO nodes VALUES (5, 2, 't', 1, NOW(), 3, '', ST_SetSRID(ST_GeomFromText('POINT(3.5 3.5)'), 4326));
